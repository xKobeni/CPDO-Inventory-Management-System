      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div className="min-w-0">
          ...
          <p className="text-sm text-muted-foreground">
            Supplies past their expiration date. Consider disposing or flagging these items.
          </p>
        </div>
          ...
          <Table className="w-full table-auto">
            ...
            <TableBody>
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={5} className="h-24 text-center text-muted-foreground">
                    No expired items match your filters.
                  </TableCell>
                </TableRow>
              ) : (
                filteredItems.map((item, i) => (
                  <TableRow key={item._id ?? item.id ?? i}>
                    ...
                    <TableCell className="px-3 py-2">
                      {item.expirationDate ? <ExpirationBadge date={item.expirationDate} /> : "—"}
                    </TableCell>
                  </TableRow>
                ))
              )}
